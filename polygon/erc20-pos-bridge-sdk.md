...
![mumbai](https://github.com/figment-networks/learn-tutorials/raw/master/assets/erc20-pos-mumbai.png)
...
* Choose **Gorli Testnet -> Mumbai testnet**
	...
	![map image](https://github.com/figment-networks/learn-tutorials/raw/master/assets/erc20-pos-map.png)
...
![mapped image](https://github.com/figment-networks/learn-tutorials/raw/master/assets/erc20-pos-mapped.png)
...
![metamask after map](https://github.com/figment-networks/learn-tutorials/raw/master/assets/erc20-pos-metamask-after-map.png)
...
![MLB Metamask](https://github.com/figment-networks/learn-tutorials/raw/master/assets/erc20-MLB-token.png)
...
2. Make sure Ethereum Mainnet is selected in Metamask
	...
	![Metamask Ethereum](https://github.com/figment-networks/learn-tutorials/raw/master/assets/erc20-pos-metamask-eth-mainnet.png)
...
4. You will be asked to sign a **Signature Request** to make sure you have access to the wallet. It costs no fees
	...
	![pos web ui login](https://github.com/figment-networks/learn-tutorials/raw/master/assets/erc20-pos-web-ui-login.png)
	
5. I chose `DAI` token from Ethereum

	![DAI](https://github.com/figment-networks/learn-tutorials/raw/master/assets/erc20-pos-web-ui-dai.png)
...
7. Then review the transaction details, like gas fees and the smart contract you are sending tokens to - before clicking on **Confirm**
	...
	![transfer](https://github.com/figment-networks/learn-tutorials/raw/master/assets/erc20-pos-web-ui-transfer.png)
