...
Figment Learn’s main objective is to build a community of missionaries where developers are not only incentivized to learn but also to share with others, but are rewarded for doing so. 
...
Get started today by reviewing available Pathways here or [apply today](https://bit.ly/figment-learn-contribute) to become a Learn contributor!

Subscribe to the Learn newsletter to be the first to know about new protocols launches, upcoming Pathways, and new tutorials!
