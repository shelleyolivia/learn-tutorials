...
**Practical Byzantine Fault Tolerance (pBFT)** — a leader is chosen amongst the parties attempting to come to a consensus. When a request comes in, the leader broadcasts it to everyone in the group. When it receives identical responses from >2/3 of the group, it reaches a consensus. For blockchain, parties coming to a consensus are nodes in the network, and amongst them, a new leader is chosen each consensus round.
...
![Kernel](../../../.gitbook/assets/kernel.png)
...
![Data Storage](../../../.gitbook/assets/data_deck.png)
