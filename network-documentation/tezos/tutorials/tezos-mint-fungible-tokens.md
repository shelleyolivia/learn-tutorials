...
For transfer also, we need the user to connect his wallet and sign the transfer method.
...
And in the end, we close the Transfer function and default export it.
