...
If you don't have any Matic token in Polygon Testnet then use [Matic Faucet](https://faucet.polygon.technology/) to get 1 Matic token to pay gas fees.
