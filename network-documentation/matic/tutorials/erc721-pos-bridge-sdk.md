Introduction
===
In this tutorial, we will go through the process of transferring ERC-721 tokens to the Polygon (Matic) chain, and from Polygon Matic to the Ethereum chain using the Polygon PoS SDK.  
We will use the **Ethereum Goerli** testnet and **Polygon Mumbai** testnet, and an ERC-721 that has been deployed and its source code has been verified on Etherscan. There is [a step-by-step guide](https://github.com/mlibre/blockchain/tree/master/Ethereum/ERC721) written by the author of this tutorial.  
...
# Setting up Metamask
Before we get into the details of moving the tokens, let's set up **Metamask** so we can check our **ETH**, **MATIC**, and **MLBn** token balances.
...
You can fund your account with testnet Ether from the [Goerli Authenticated faucet](https://faucet.goerli.mudit.blog/) as long as you are willing to make a post on a valid Twitter or Facebook account. If this is not something you wish to do, there is an alternative faucet at [goerli-faucet.slock.it](https://goerli-faucet.slock.it/)
  ...
  ![MLBn balance](../../../.gitbook/assets/erc721-pos-metamask-goerli-fund.png)
...
![mumbai](../../../.gitbook/assets/erc721-pos-mumbai.png)
...
We'll map this contract and transfer the NFT.  
You can find a step-by-step guide to creating an ERC-721 token [here](https://github.com/mlibre/blockchain/tree/master/Ethereum/ERC721)  
...
# Mapping
Now that everything is ready. Let's map our `MLBn` contract.
...
![mapped image](../../../.gitbook/assets/erc721-pos-mapped.png)
...
3. Add Token
4. Paste the contract address there (`0xf6320326327c07759602423f01D8fad4AF9E3f24`)
